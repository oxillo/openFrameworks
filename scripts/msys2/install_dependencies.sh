...
pacman -S $confirm ca-certificates mingw-w64-$arch-harfbuzz
...
pacman -Sy $confirm --needed make mingw-w64-$arch-gcc mingw-w64-$arch-glew mingw-w64-$arch-freeglut mingw-w64-$arch-FreeImage mingw-w64-$arch-opencv mingw-w64-$arch-assimp \
							 ...
							 mingw-w64-$arch-poco mingw-w64-$arch-glfw mingw-w64-$arch-openal mingw-w64-$arch-kiss_fft mingw-w64-$arch-mpg123 mingw-w64-$arch-libsndfile mingw-w64-$arch-libusb
