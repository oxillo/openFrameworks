...
ifeq ($(LIB_ARCH),x64)
	PLATFORM_PROJECT_RELEASE_BIN_NAME=$(APPNAME)_x64.exe
	PLATFORM_PROJECT_DEBUG_BIN_NAME=$(APPNAME)_x64_debug.exe
else ifeq ($(LIB_ARCH),Win32)
...
ifeq ($(LIB_ARCH),x64)
	#PLATFORM_CORE_EXCLUSIONS += $(OF_LIBS_PATH)/glfw/lib/msys2/Win32/%
	#PLATFORM_CORE_EXCLUSIONS += $(OF_LIBS_PATH)/kiss/lib/msys2/Win32/%
	#PLATFORM_CORE_EXCLUSIONS += $(OF_LIBS_PATH)/tess2/lib/msys2/Win32/%
endif
ifeq ($(LIB_ARCH),Win32)
	#PLATFORM_CORE_EXCLUSIONS += $(OF_LIBS_PATH)/glfw/lib/msys2/x64/%
	#PLATFORM_CORE_EXCLUSIONS += $(OF_LIBS_PATH)/kiss/lib/msys2/x64/%
	#PLATFORM_CORE_EXCLUSIONS += $(OF_LIBS_PATH)/tess2/lib/msys2/x64/%
endif
